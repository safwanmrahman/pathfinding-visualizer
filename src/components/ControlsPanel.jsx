      ...
      <div className="controls-layout">
        <article className="panel-card">
          <div className="panel-heading">
            ...
            <h3>Pick the strategy you want to compare</h3>
          </div>
        ...
        <article className="panel-card">
          <div className="panel-heading">
            <p className="panel-kicker">Primary Tools</p>
            <h3>Control drawing, movement, and playback</h3>
          </div>
          ...
          <div className="stack">
            ...
            <div className="tool-selector" role="radiogroup" aria-label="Draw tool">
        ...
        <article className="panel-card action-panel">
          <div className="panel-heading">
            <p className="panel-kicker">Run Actions</p>
            <h3>Animate, inspect, and reset quickly</h3>
          </div>
        ...
        <article className="panel-card secondary-actions-panel">
          <div className="panel-heading">
            <p className="panel-kicker">Board Actions</p>
            <h3>Scenario generation and cleanup</h3>
          </div>
